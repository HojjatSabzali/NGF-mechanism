...
load('rawdataEditedZeroedFinal.mat');
Zerodata = data;
clear data
format compact
...
% step_size = 13; %Resolution of Making ICOR Path
...
for j = 1:1:N_Step
    ...
    syms x1 xp1
    %i = ((j-1)*step_size) + 1 ;
    ii = [1    14    27    53    46    59   53   66    79    82];%[1    14    27    40    53    66    79    99or85];[1    14    27    38    53   46    59   53   66    79    82];[1    14    27    38    53   46    59   53   66    79    82];
    i = ii(1,j);
